import IChocoValidation from "../interfaces/IChocoValidation";

class ChocoValidation {
    ...
    constructor(validation?: Partial<IChocoValidation>) {
        if (validation) {
...
export default ChocoValidation;